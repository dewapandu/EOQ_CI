        ...
        <form action="<?php echo base_url('barang_store') ?>" method="POST" name="create_barang">
            ...
            <div class="row gy-3">
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" name="biaya_penyimpanan" placeholder="Masukkan biaya penyimpanan" required />
                </div>
                <div class="col-6">
                    <label class="form-label">Periode Permintaan</label>
                    <input type="text" class="form-control" name="periode_permintaan" placeholder="Masukkan periode permintaan" required />
                </div>
                <div class="col-6">
                ...
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" name="konversi" placeholder="Masukkan konversi" required />
                </div>
                <div class="col-12">
