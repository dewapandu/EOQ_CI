...
<div class="main__wrapper">
    <div class="container pt-5">
        ...
        <form action="<?php echo base_url('bagian_store') ?>" method="POST" name="edit_bagian">
            <input type="hidden" name="id_bagian" value="<?php echo $bagian->id_bagian ?>" />
            <div class="row gy-3">
                <div class="col-6">
                    <label class="form-label">Nama Bagian</label>
                    <input type="text" class="form-control" name="nama_bagian" placeholder="Masukkan nama bagian" value="<?php echo $bagian->nama_bagian ?>" required />
                </div>
                <div class="col-12">
